...
export const TableKYC = () => {
  ...
  return (
    <Table className="overflow-scroll max-w-[80vw]">
      ...
      <Tbody>
        <a className="table-row cursor-pointer bg-blackDark text-center hover:bg-appShade200/50 transition-all duration-300 border-b border-app-shade">
          ...
          <TableBody>WALAO</TableBody>
          <TableBody>
            WALAOWALAOWALAOWALAOWALAOWALAOWALAOWALAOWALAOWALAO WALAO WALAO WALAO
          </TableBody>
        </a>
      </Tbody>
    </Table>
